...
public class BoardRepositoryTest {
    ...
    public void getProductDtosToDuplicatedTagsTest() {
        ...
        List<String> actualDuplicatedTags = boardRepository.getProductDtosToDuplicatedTags(
            productDtos);

        assertThat(actualDuplicatedTags,
            containsInAnyOrder("glutenFree", "sugarFree", "highProtein", "ketogenic"));
    ...
    public void getBoardResponseDtoTest() {
        var boardDetailResponse = boardRepository.getBoardDetailResponse(member.getId(),
            board.getId());
        ...
        assertThat(firstBoard.tags(),
            containsInAnyOrder("glutenFree", "sugarFree", "vegan", "ketogenic"));
        ...
        assertThat(firstProductTag,
            arrayContaining("glutenFree", "sugarFree", "vegan", "ketogenic"));
    }
