...
public class AdminController {
    ...
    @PostMapping(value = "/stores/{storeId}/board", consumes = {"multipart/form-data", "application/json"})
    ...
    @PostMapping(value = "/stores/{storeId}/boards/{boardId}/subimage", consumes = {"multipart/form-data", "application/json"})
    public ResponseEntity<AdminBoardImgResponseDto> uploadBoardImg(
        ...
        return ResponseEntity.ok().body(
                ...
                AdminBoardImgResponseDto.builder()
                        .message(adminService.uploadBoardImage(storeId, boardId, subImage) ? "저장 성공":"저장 실패")
                        .build()
        );
    }
